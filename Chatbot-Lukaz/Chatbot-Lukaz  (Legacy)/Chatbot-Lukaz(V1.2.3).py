...
pairs = [
    ...
    (r'oi Lukaz|Oi Lukaz|olá Lukaz|Olá Lukaz', ['Olá Rafael!', 'Oi Rafael!', 'Como vai, Rafael?']),
    ...
    (r'Eu não sou o Rafael|eu não sou o Rafael|Eu não sou o rafael|eu não sou o rafael', ['Neste caso, devo pedir que se retire deste computador, pois ele pertence ao Rafael.']),
]
